...
const AccessibilityPermissions: React.FC = () => {
  ...
  // The first prompt reads as the primary action; the re-check is secondary.
  const buttonVariant = permissionState === "request" ? "primary" : "secondary";
  ...
  return (
    <Card className="p-4 w-full max-w-3xl mx-auto">
      <div className="flex justify-between items-center gap-2">
        ...
        <Button variant={buttonVariant} size="sm" onClick={handleButtonClick}>
