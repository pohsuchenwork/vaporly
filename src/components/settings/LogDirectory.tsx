...
export const LogDirectory: React.FC<LogDirectoryProps> = ({
  ...
  return (
    <SettingContainer
      title={t("settings.general.about.logDirectory.title")}
      description={t("settings.general.about.logDirectory.description")}
    ...
    >
      {loading ? (
        <div className="animate-pulse">
          <div className="h-8 bg-surface-well rounded-control" />
        </div>
      ) : error ? (
        <div className="p-3 bg-danger-tint rounded-control text-xs text-danger">
