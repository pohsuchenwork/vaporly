{
  description = "Vaporly - fully local speech-to-text with AI cleanup (built on Handy)";
  ...
  outputs =
    ...
    in
    {
      packages = forAllSystems (
        ...
        in
        {
          vaporly = pkgs.rustPlatform.buildRustPackage {
            pname = "vaporly";
            inherit version;
            src = self;
            ...
            meta = {
              ...
              homepage = "https://github.com/pohsuchenwork/vaporly";
          ...
          default = self.packages.${system}.vaporly;
        }
      );
      ...
      nixosModules.default =
        { lib, pkgs, ... }:
        {
          ...
          programs.vaporly.package = lib.mkDefault self.packages.${pkgs.stdenv.hostPlatform.system}.vaporly;
        };
      ...
      homeManagerModules.default =
        { lib, pkgs, ... }:
        {
          ...
          services.vaporly.package = lib.mkDefault self.packages.${pkgs.stdenv.hostPlatform.system}.vaporly;
        };
      ...
      devShells = forAllSystems (
        ...
        in
        {
          default = pkgs.mkShell {
            ...
            shellHook = ''
              echo "Vaporly development environment"
              bun install
